  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="bg-white border-[3px] border-ink w-full max-w-md p-7 shadow-comic-xl relative"
          ...
          >
            <button
              ...
              onClick={onClose}
            >✕</button>
            <h2 className="font-comic text-3xl tracking-wide border-b-[3px] border-ink pb-3 mb-5">{title}</h2>
            {children}
          </motion.div>
        </motion.div>
      )}
